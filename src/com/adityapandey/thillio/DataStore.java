...
import com.adityapandey.thillio.constants.Gender;
...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[2] = UserManager.getInstance().createUser(1002, "user2@semanticsquare.com", "test", "Anita", "M",
				Gender.TRANSGENDER, UserType.EDITOR);
	...
	private static void loadMovies() {
		...
		bookmarks[1][1] = BookmarkManager.getInstance().createMovie(3001, "The Grapes of Wrath	1940", "", 1941,
	...
	private static void loadBooks() {
		...
		bookmarks[2][4] = BookmarkManager.getInstance().createBook(4004, "Effective Java Programming Language Guide",
				"", 2007, "O'Reilly Media", new String[] { "Prentice Hall", "Joshua Bloch" }, BookGenre.TECHNICAL, 4.9);
